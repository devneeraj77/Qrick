...
import { Download, Sparkles, Loader2, Copy, QrCode, ChartScatter } from "lucide-react";
  ...
  const downloadQRCode = (format: "svg" | "png") => {
    ...
    if (format === "svg") {
      ...
      img.onload = () => {
        ...
        const text = "Generated by QRick";
        ctx.font = "10px Inter, sans-serif";
        ctx.fillStyle = "#5e716a";
        ctx.textAlign = "center";
        const textYPosition = padding + qrSize + 80; // 40px below the QR
          
        ctx.fillText(text, templateSize / 2, textYPosition);
